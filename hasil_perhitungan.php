...
// $dat =mysqli_query($konek,"select * from tb_hasil where keterangan='Very Dry'");
											...
											<div id="menu5" class="tab-pane fade in ">
												...
												<h4>FUZZIFICATION</h1>
													<table class='table table-bordered' style="width:930px">
														...
														{
															$sql = mysqli_query($konek, "SELECT * from tb_rule_kondisi where kondisi_1 LIKE '%$kondisi_1%' and kondisi_2 LIKE '" . $kondisi_2 . "'  and kondisi_3 LIKE '" . $kondisi_3 . "' ");
															while ($row = mysqli_fetch_array($sql)) {
																$kondisi = $row['hasil'];
															}
															return $kondisi;
									...
									";
															...
															<h4>AGGREGATION</h1>
																<table class='table table-bordered' style="width:930px">
																	...
																	{
																		$nilai = 0;
																		$sql = mysqli_query($konek, "SELECT * from tb_rule_duration where keterangan='" . $kondisi_1 . "' LIMIT 0,4");
																		while ($row = mysqli_fetch_array($sql)) {
																...
																<h4>DEFUZZIFICATION</h1>
																	...
																	mysqli_query($konek, "INSERT INTO tb_hasil_menit(tanggal,suhu,sm,humidity,li,aggre,defuz,nilai)VALUES('" . $_POST['tanggal'] . "','" . $_POST['suhu'] . "','" . $_POST['sm'] . "','" . $_POST['hm'] . "','" . $_POST['li'] . "','" . $_POST['aggre'] . "','$gol','" . $hasil_meni . "')");
																	?>
											</div>
										</div>
									</div>
