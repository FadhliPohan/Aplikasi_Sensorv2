...
<div class="main-panel" style="background-image:url(background.jpg)">
				...
				<div class="col-md-10">
					<table bordercolor="#0C1015" bgcolor="#9900FF" class="table table-bordered" style="background-color:white">
						<tr>
							...
							<td bgcolor="#9966CC">AMMONIA (NH3) (%)</td>
							<td bgcolor="#9966CC">HUMIDITY (%)</td>
							<td bgcolor="#9966CC">CARBON DIOXIDE (CO2)</td>

						</tr>
						<tr>
							<?php
							$sql = "SELECT * from tb_hasil_menit ORDER BY id_hasil DESC LIMIT 0,1";
						...
						<tr>
							...
							<td colspan="2" bgcolor="#9966CC" style="text-align:center">
								...
								<h3 class="style1"> DURATION DRIP
									<?php echo $nilai; ?>
									SECONDS</h3>
								<h3 class="style1"> AMMONIA GAS MONITORING IN FERTILIZER PRODUCING FACTORIES USING THE INTERNET OF THINGS
									WITH FUZZY RULE BASED ALGORITHM
								</h3>
							</td>
