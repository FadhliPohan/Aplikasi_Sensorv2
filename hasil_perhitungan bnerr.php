		...
		<div class="panel panel-default">
				...
				<div class="container">
				  ...
				  <div class="tab-content">
					...
					<?php 
						$judul = mysqli_query($konek,"SELECT * FROM tb_hasil WHERE keterangan = 'Very Cold' OR keterangan = 'Cold' OR keterangan = 'Normal' AND golongan = '0' OR keterangan = 'Hot' OR keterangan = 'Very Hot'")or die(mysqli_error());	
					 ?>
					...
					<ul class="list-group">						
						...
						<table>
							<tr>
							<?php
							$data0=mysqli_query($konek,"select *  from tb_hasil ");
				...
				<table class="table table-bordered" style="width:900px">
									...
									$nomor=1;
									$nomor1=1;
									$sql=mysql_query($konek,"SELECT * FROM `tb_rule` WHERE is_golongan='0' and nilai='".$_POST['suhu']."' GROUP BY is_sub_golongan,keterangan_nilai");
									while($row=mysql_fetch_array($sql)){
										$sql2=mysql_query($konek,"SELECT MIN( nilai ) AS nilai_bawah, MAX( nilai ) AS nilai_atas
															FROM  `tb_rule` 
															WHERE is_golongan =  '0'
				...
				<table class="table table-bordered" style="width:900px">
					...
					<?php
						$nomor=1;
					$sql=mysql_query($konek,"SELECT * FROM `tb_rule` WHERE is_golongan='0' GROUP BY is_sub_golongan,keterangan_nilai ORDER BY id_golongan ASC");
					while($row=mysql_fetch_array($sql)){
						if($row['is_sub_golongan'] == 1){
...
<div style="height:60px;width:800px;background-color:white;z-index: 99;margin-top:30px; position: absolute">
			...
			<div id="chartContainer2" style="height: 370px;width:800px;"></div>
				...
				<table class='table table-bordered'>
					...
					$nomor2=3;
					$suhu=$_POST['sm'];
					$sql=mysql_query($konek,"SELECT * FROM `tb_rule` WHERE is_golongan='1' and nilai='".$_POST['sm']."' GROUP BY is_sub_golongan,keterangan_nilai ORDER BY id_golongan ASC");
					while($row=mysql_fetch_array($sql)){
						$sql2=mysql_query($konek,"SELECT MIN( nilai ) AS nilai_bawah, MAX( nilai ) AS nilai_atas
											FROM  `tb_rule` 
											WHERE is_golongan =  '1'
				...
				<table class="table table-bordered" style="width:900px">
					...
					$sql=mysql_query($konek,"SELECT * FROM `tb_rule` WHERE is_golongan='1' GROUP BY is_sub_golongan,keterangan_nilai ORDER BY id_golongan ASC");
					while($row=mysql_fetch_array($sql)){
						if($row['is_sub_golongan'] == 1){
...
<!-- PERHITUNGAN UNTUK HUMIDITY -------------------------------------------------------------------------------------------->
				...
				<table class='table table-bordered'>
					...
					$nomor3=5;
					$suhu=$_POST['hm'];
					$sql=mysql_query($konek,"SELECT * FROM `tb_rule` WHERE is_golongan='2' and nilai='".$_POST['hm']."' GROUP BY is_sub_golongan,keterangan_nilai ORDER BY id_golongan ASC");
					while($row=mysql_fetch_array($sql)){
						$sql2=mysql_query($konek,"SELECT MIN( nilai ) AS nilai_bawah, MAX( nilai ) AS nilai_atas
											FROM  `tb_rule` 
											WHERE is_golongan =  '2'
				...
				<table class="table table-bordered" style="width:900px">
					...
					<?php
						$nomor=1;
					$sql=mysql_query($konek,"SELECT * FROM `tb_rule` WHERE is_golongan='2' GROUP BY is_sub_golongan,keterangan_nilai ORDER BY id_golongan ASC");
					while($row=mysql_fetch_array($sql)){
						if($row['is_sub_golongan'] == 1){
												$nama_golongan="Trapezoid";
													$nilai_b="D";
...
<div style="height:60px;width:800px;background-color:white;z-index: 99;margin-top:30px; position: absolute">
				...
				<table class='table table-bordered'>
					...
					$nomor4=7;
					$suhu=$_POST['li'];
					$sql=mysql_query($konek,"SELECT * FROM `tb_rule` WHERE is_golongan='3' and nilai='".$_POST['li']."' GROUP BY is_sub_golongan,keterangan_nilai ORDER BY id_golongan ASC");
					while($row=mysql_fetch_array($sql)){
						$sql2=mysql_query($konek,"SELECT MIN( nilai ) AS nilai_bawah, MAX( nilai ) AS nilai_atas
											FROM  `tb_rule` 
											WHERE is_golongan =  '3'
				...
				<table class="table table-bordered" style="width:900px">
					...
					<?php
						$nomor=1;
					$sql=mysql_query($konek,"SELECT * FROM `tb_rule` WHERE is_golongan='3' GROUP BY is_sub_golongan,keterangan_nilai ORDER BY id_golongan ASC");
					while($row=mysql_fetch_array($sql)){
						if($row['is_sub_golongan'] == 1){
												$nama_golongan="Trapezoid";
													$nilai_b="D";
...
<!-- PERHITUNGAN UNTUK FUZYFICATION -------------------------------------------------------------------------------------------->
					...
					<table class='table table-bordered' style="width:930px">
						...
						function get_rule_kondisi($kondisi_1,$kondisi_2,$kondisi_3){
							$sql=mysql_query($konek,"SELECT * from tb_rule_kondisi where kondisi_1 LIKE '%$kondisi_1%' and kondisi_2 LIKE '".$kondisi_2."'  and kondisi_3 LIKE '".$kondisi_3."' ");
								while($row=mysql_fetch_array($sql)){
									$kondisi=$row['hasil'];
								}
								return $kondisi;
						}
							$sql=mysql_query($konek,"SELECT * from tb_hasil where golongan='0' ORDER BY id_hasil ASC");
								while($row=mysql_fetch_array($sql)){
									...
									";
									$sql2=mysql_query($konek,"SELECT * from tb_hasil where golongan='1' ORDER BY id_hasil ASC");
										$nomor1=1;
								while($row_6=mysql_fetch_array($sql2)){
									$nomor2=2;
									$sql3=mysql_query($konek,"SELECT * from tb_hasil where golongan='2' ORDER BY id_hasil ASC");
										while($row_7=mysql_fetch_array($sql3)){
												$sql4=mysql_query($konek,"SELECT * from tb_hasil where golongan='3' ORDER BY id_hasil ASC");
...
<!-- PERHITUNGAN UNTUK APPLICATION -------------------------------------------------------------------------------------------->
					...
					<table class='table table-bordered' style="width:930px">
						...
						$ra=0;
							...
							$sql=mysql_query($konek,"SELECT * from tb_hasil where golongan='0' ");
								while($row=mysql_fetch_array($sql)){
									...
									";
									$sql2=mysql_query($konek,"SELECT * from tb_hasil where golongan='1' ");
								while($row_6=mysql_fetch_array($sql2)){
									$sql22=mysql_query($konek,"SELECT * from tb_hasil where golongan='2' ");
									while($row_7=mysql_fetch_array($sql22)){
										$sql4=mysql_query($konek,"SELECT * from tb_hasil where golongan='3' ");
													while($row_8=mysql_fetch_array($sql4)){
																if($row_8['keterangan'] == "gelap"){
												$ket="Dark";
											}else if($row_8['keterangan'] == "redup"){
...
<!-- PERHITUNGAN UNTUK FUZYFICATION -------------------------------------------------------------------------------------------->
					...
					<table class='table table-bordered' style="width:930px">
						...
						function get_duration($kondisi_1,$nilai_set){
							$nilai=0;
							$sql=mysql_query($konek,"SELECT * from tb_rule_duration where keterangan='".$kondisi_1."' LIMIT 0,4");
								while($row=mysql_fetch_array($sql)){
						...
						$nomor=1;
							//$total=0;
							//$total_bagi=0;
							$sql=mysql_query($konek,"SELECT golongan,MAX(hasil)as total_max from tb_hasil_2 GROUP BY golongan ");
								while($row=mysql_fetch_array($sql)){
...
<!-- PERHITUNGAN UNTUK DEFUZYFICATION -------------------------------------------------------------------------------------------->
					...
					<?php
						...
						$nomor=1;
							$total=0;
							$total_bagi=0;
							$sql=mysql_query($konek,"SELECT golongan,MAX(hasil)as total_max from tb_hasil_2 GROUP BY golongan  ORDER BY hasil DESC limit 0,1 ");
								while($row=mysql_fetch_array($sql)){
									$total_set=$row['total_max']*4;
...
var options = {
	...
	data: [
	<?php
		$data_very_dry=mysql_query($konek,"select COUNT(*)AS TOTAL from tb_hasil where keterangan='Very Dry'");
		$row_very_dry=mysql_fetch_array($data_very_dry);
		
		if($row_very_dry['TOTAL'] > 0){
		$get = mysql_fetch_array(mysql_query($konek,"select * from tb_hasil where keterangan='Very Dry'"));
	?>
	{
	...
	?>
	<?php
		$data_dry=mysql_query($konek,"select COUNT(*)AS TOTAL from tb_hasil where keterangan='Dry'");
		$row_dry=mysql_fetch_array($data_dry);
		
		if($row_dry['TOTAL'] > 0){
		//manggil data hasil perhitungan dalam array, 
		$getdry = mysql_fetch_array(mysql_query($konek,"select * from tb_hasil where keterangan='Dry'"));
	?>
	{
	//nilai bawah
		type: "line", //change it to line, area, column, pie, etc
	...
	?>
	<?php
		$data_normal=mysql_query($konek,"select COUNT(*)AS TOTAL from tb_hasil where keterangan='Normal' and golongan='1'");
		$row_normal=mysql_fetch_array($data_normal);
		
		if($row_normal['TOTAL'] > 0){
		$get = mysql_fetch_array(mysql_query($konek,"select * from tb_hasil where keterangan='Normal' and golongan='0'"));
	?>
{
...
?>
<?php
		$data_wet=mysql_query($konek,"select COUNT(*)AS TOTAL from tb_hasil where keterangan='Wet'");
		$row_wet=mysql_fetch_array($data_wet);
		
		if($row_wet['TOTAL'] > 0){
		$get = mysql_fetch_array(mysql_query($konek,"select * from tb_hasil where keterangan='Wet'"));
	?>
{
	type: "line", //change it to line, area, column, pie, etc
		dataPoints: [
	...
	?>
	<?php
		$data_very_wet=mysql_query($konek,"select COUNT(*)AS TOTAL from tb_hasil where keterangan='Very Wet'");
		$row_very_wet=mysql_fetch_array($data_very_wet);
		
		if($row_very_wet['TOTAL'] > 0){
		$get = mysql_fetch_array(mysql_query($konek,"select * from tb_hasil where keterangan='Very Wet'"));
	?>
{
		type: "line", //change it to line, area, column, pie, etc
		dataPoints: [
...
var options2 = {
	...
	data: [
	<?php
		$data_very_cold=mysql_query($konek,"select COUNT(*)AS TOTAL from tb_hasil where keterangan='Very Cold'");
		$row_very_cold=mysql_fetch_array($data_very_cold);
		
		if($row_very_cold['TOTAL'] > 0){
			$get = mysql_fetch_array(mysql_query($konek,"select * from tb_hasil where keterangan='Very Cold'"));
	?>
	{
	...
	?>
	<?php
		$data_cold=mysql_query($konek,"select COUNT(*)AS TOTAL from tb_hasil where keterangan='Cold'");
		$row_cold=mysql_fetch_array($data_cold);
		
		if($row_cold['TOTAL'] > 0){
			//manggil data hasil perhitungan dalam array, 
			$getcold = mysql_fetch_array(mysql_query($konek,"select * from tb_hasil where keterangan='Cold'"));			
	...
	?>
	<?php
		$data_fresh=mysql_query($konek,"select COUNT(*)AS TOTAL from tb_hasil where keterangan='Normal' and golongan='0'");
	...
	?>
	<?php
		$data_hot=mysql_query($konek,"select COUNT(*)AS TOTAL from tb_hasil where keterangan='Hot'");
		$row_hot=mysql_fetch_array($data_hot);
		
		if($row_hot['TOTAL'] > 0){
			$get = mysql_fetch_array(mysql_query($konek,"select * from tb_hasil where keterangan='Hot'"));			
	?>
	{
		type: "line", //change it to line, area, column, pie, etc
		dataPoints: [
	...
	?>
	<?php
		$data_hot=mysql_query($konek,"select COUNT(*)AS TOTAL from tb_hasil where keterangan='Very Hot'");
		$row_hot=mysql_fetch_array($data_hot);
		
		if($row_hot['TOTAL'] > 0){
			$get = mysql_fetch_array(mysql_query($konek,"select * from tb_hasil where keterangan='Very Hot'"));			
...
var options3 = {
	...
	data: [
	<?php
		$data_very_low=mysql_query($konek,"select COUNT(*)AS TOTAL from tb_hasil where keterangan='Very Low'");
		$row_very_low=mysql_fetch_array($data_very_low);
		
		if($row_very_low['TOTAL'] > 0){
		$get = mysql_fetch_array(mysql_query($konek,"select * from tb_hasil where keterangan='Very Low'"));
	?>
	{
	...
	?>
	<?php
		$data_low=mysql_query($konek,"select COUNT(*)AS TOTAL from tb_hasil where keterangan='Low'");
		$row_low=mysql_fetch_array($data_low);
		
		if($row_low['TOTAL'] > 0){
			$get = mysql_fetch_array(mysql_query($konek,"select * from tb_hasil where keterangan='Low'"));
	?>
	{
	//nilai bawah
		type: "line", //change it to line, area, column, pie, etc
	...
	?>
	<?php
		$data_low_normal=mysql_query($konek,"select COUNT(*)AS TOTAL from tb_hasil where keterangan='Normal' and golongan='2'");
		$row_low_normal=mysql_fetch_array($data_low_normal);
		
		if($row_low_normal['TOTAL'] > 0){
			$get = mysql_fetch_array(mysql_query($konek,"select * from tb_hasil where keterangan='Normal'"));
	?>
{
		type: "line", //change it to line, area, column, pie, etc
		dataPoints: [
	...
	?>
	<?php
		$data_high=mysql_query($konek,"select COUNT(*)AS TOTAL from tb_hasil where keterangan='High'");
		$row_high=mysql_fetch_array($data_high);
		
		if($row_high['TOTAL'] > 0){
			$get = mysql_fetch_array(mysql_query($konek,"select * from tb_hasil where keterangan='High'"));
	?>
	{
		type: "line", //change it to line, area, column, pie, etc
		dataPoints: [
	...
	?>
	<?php
		$data_very_high=mysql_query($konek,"select COUNT(*)AS TOTAL from tb_hasil where keterangan='Very High'");
		$row_very_high=mysql_fetch_array($data_very_high);
		
		if($row_very_high['TOTAL'] > 0){
			$get = mysql_fetch_array(mysql_query($konek,"select * from tb_hasil where keterangan='Very High'"));
	?>
	{
		type: "line", //change it to line, area, column, pie, etc
		dataPoints: [
...
var options5 = {
	...
	data: [
	<?php
		$data_gelap=mysql_query($konek,"select COUNT(*)AS TOTAL from tb_hasil where keterangan='gelap'");
		$row_gelap=mysql_fetch_array($data_gelap);
		if($row_gelap['TOTAL'] > 0){
			$get = mysql_fetch_array(mysql_query($konek,"select * from tb_hasil where keterangan='Gelap'"));
	?>
	{
	...
	?>
	<?php
		$data_redup=mysql_query($konek,"select COUNT(*)AS TOTAL from tb_hasil where keterangan='redup'");
		$row_redup=mysql_fetch_array($data_redup);
		if($row_redup['TOTAL'] > 0){
		//manggil data hasil perhitungan dalam array, 
			$getredup = mysql_fetch_array(mysql_query($konek,"select * from tb_hasil where keterangan='Redup'"));
	?>
	{
	//nilai bawah
		type: "line", //change it to line, area, column, pie, etc
	...
	?>
	<?php
		$data_normal_lig=mysql_query($konek,"select COUNT(*)AS TOTAL from tb_hasil where keterangan='Normal' and golongan='3'");
	...
	?>
{
	...
	?>
	<?php
		$data_agak_terang=mysql_query($konek,"select COUNT(*)AS TOTAL from tb_hasil where keterangan='agak_terang'");
...
type: "line", //change it to line, area, column, pie, etc
	...
	?>
	<?php
		$data_terang=mysql_query($konek,"select COUNT(*)AS TOTAL from tb_hasil where keterangan='terang'");
		$row_terang=mysql_fetch_array($data_terang);
		if($row_terang['TOTAL'] > 0){
			$get = mysql_fetch_array(mysql_query($konek,"select * from tb_hasil where keterangan='terang'"));
	?>
	{
