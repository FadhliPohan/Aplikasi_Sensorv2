		...
		<div class="panel panel-default">
				...
				<div class="container">
				  ...
				  <div class="tab-content">
					...
					mysqli_query($konek,"INSERT INTO tb_hasil(urutan,golongan,nilai,keterangan,hasil)VALUES('$nomor','0','".$_POST['suhu']."','".$row['keterangan_nilai']."','".number_format($hasil,2)."')");
...
<!-- PERHITUNGAN UNTUK SOIL MOISTURE -------------------------------------------------------------------------------------------->
			...
			<div id="chartContainer2" style="height: 370px;width:800px;"></div>
				...
				<table class='table table-bordered'>
					...
					mysqli_query($konek,"INSERT INTO tb_hasil(urutan,golongan,nilai,keterangan,hasil)VALUES('$nomor','1','".$_POST['sm']."','".$row['keterangan_nilai']."','".number_format($hasil,2)."')");
...
<!-- PERHITUNGAN UNTUK HUMIDITY -------------------------------------------------------------------------------------------->
				...
				<table class='table table-bordered'>
					...
					mysqli_query($konek,"INSERT INTO tb_hasil(urutan,golongan,nilai,keterangan,hasil)VALUES('$nomor','2','".$_POST['hm']."','".$row['keterangan_nilai']."','".number_format($hasil,2)."')");
...
<div style="height:60px;width:800px;background-color:white;z-index: 99;margin-top:30px; position: absolute"></div>
				...
				<table class='table table-bordered'>
					...
					mysqli_query($konek,"INSERT INTO tb_hasil(urutan,golongan,nilai,keterangan,hasil)VALUES('$nomor','3','".$_POST['li']."','".$row['keterangan_nilai']."','".number_format($hasil,2)."')");
...
$konek      = mysqli_connect($host, $user, $password,$database) or die("Gagal konek ke server MySQLi" .mysqli_error());
							...
							$sql=mysqli_query($konek,"SELECT * from tb_hasil where golongan='0' ");
								...
								while($row_6=mysqli_fetch_array($sql2)){
									$sql3=mysqli_query($konek,"SELECT * from tb_hasil where golongan='2' ");
...
<!-- PERHITUNGAN UNTUK DEFUZYFICATION -------------------------------------------------------------------------------------------->
					...
					<?php
							...
							mysqli_query($konek,"UPDATE tb_hasil_menit SET tanggal='".$_POST['tanggal']."',suhu='".$_POST['suhu']."',sm='".$_POST['sm']."',humidity='".$_POST['hm']."',li='".$_POST['li']."',nilai='".round($hasil_meni)."' where id_hasil='".$_POST['id_hasil']."'");
